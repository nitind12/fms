...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2019 at 08:43 AM
...
('BCA 1 A-2019-2020', 1, '2019-2020'),
('BCA 1 B-2019-2020', 2, '2019-2020'),
('BCA 2 A-2019-2020', 3, '2019-2020'),
('BCA 2 B-2019-2020', 4, '2019-2020'),
('BCA 3 A-2019-2020', 5, '2019-2020'),
('BCA 3 B-2019-2020', 6, '2019-2020'),
('BCA 4 A-2019-2020', 7, '2019-2020'),
('BCA 4 B-2019-2020', 8, '2019-2020'),
('BCA 5 A-2019-2020', 9, '2019-2020'),
('BCA 5 B-2019-2020', 10, '2019-2020'),
('BCA 6 A-2019-2020', 11, '2019-2020'),
('BCA 6 B-2019-2020', 12, '2019-2020');
...
(9, '2018-2019', 'BCA 1 A-2019-2020', 2019, 'April', 2019, 'April', 1, 'x', 1000, 'Registrati,Exam', '1000,500', 'Bus', '600', 2100, 400, 0, 250),
(10, '2018-2019', 'BCA 1 A-2019-2020', 2019, 'April', 2019, 'April', 1, 'x', 1001, 'Registrati,Exam', '1000,500', 'Karate', '400', 1900, 600, 0, 300),
(14, '2018-2019', 'BCA 1 A-2019-2020', 2019, 'April', 2019, 'April', 1, 'x', 1002, 'Registrati,Exam', '1000,500', 'Karate', '400', 1900, 200, 0, 1700),
(15, '2018-2019', 'BCA 1 A-2019-2020', 2019, 'April', 2019, 'April', 1, 'x', 1003, 'Registrati,Exam', '1000,500', '', '0', 1500, 600, 0, 900);
...
CREATE TABLE IF NOT EXISTS `fee_receipt` (
  ...
  `cheque_Date` varchar(25) NOT NULL,
...
(3, 9, 1000, '10', 1, 400, '', 2100, 1500, 50, 11, 'cash', 'SBI', '', '', '2019-05-28', '2018-19', 'fms', '2019-05-28'),
(4, 10, 1001, '10,11', 1, 600, '', 1900, 1000, 0, 11, 'cash', 'SBI', '', '', '2019-05-28', '2018-19', 'fms', '2019-05-28');
...
INSERT INTO `fee_static_head` (`static_head_ID`, `fee_Head`, `username`, `date`, `amount`, `discount_Applicable`, `how_many_Times`) VALUES
...
(31, 1014, 23, 'fms', '0000-00-00'),
(32, 1001, 20, 'fms', '0000-00-00'),
(33, 1002, 20, 'fms', '0000-00-00');
...
('2018-2019', 2018, 2019, '2019-05-21'),
('2019-2020', 2019, 2020, '2019-04-06'),
('2020-2021', 2020, 2021, '2019-04-05');
...
(3, 'BCA 1 A-2019-2020', 100, 'fms', '0000-00-00'),
(4, 'BCA 1 A-2019-2020', 101, 'fms', '0000-00-00');
...
(55, 'joshi colony, near small cynth', 1054, 'HALDWANI', 'NAINITAL', 'HALDWANI', 'Uttarakhand', 263139, NULL, NULL);
...
(6, '8765544665', 1003, '1', '2019-05-19'),
...
(53, '8765677886', 1054, NULL, '0000-00-00');
...
(1003, 'BHASKER SINGH', 'NAINWAL', 'MADAN SINGH', 'HEMA DEVI', 'GENERAL', NULL, 'INDIAN', '0000-00-00', 'A+', '1', 'fms'),
...
(1054, 'HITENDRA ', 'JOSHI', 'KAMAL JOSHI', 'HENA JOSHI', 'GENERAL', NULL, 'INDIAN', '2019-05-07', 'A+', '1', 'fms');
...
(4, 'bhaskar@gmail.com', 1003, '2019-05-19', '1'),
...
(20, 'LOVELESHHLD@GMAIL.CO', 1054, '0000-00-00', NULL);
...
(1, 1000, 'BCA 1 A-2019-2020', '2019-2020', 1, 'fms', '1', '2019-04-06'),
(2, 1001, 'BCA 1 A-2019-2020', '2019-2020', 1, 'fms', '1', '2019-04-06'),
(3, 1002, 'BCA 1 A-2019-2020', '2019-2020', 1, 'fms', '1', '2019-04-06'),
(4, 1003, 'BCA 1 A-2019-2020', '2019-2020', 1, 'fms', '1', '2019-04-06'),
(5, 1004, 'BCA 1 A-2019-2020', '2019-2020', 1, 'fms', '1', '2019-04-06');
