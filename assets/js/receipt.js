	$('body').on('click','.payhere',function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				str = str + '</td>';
				str = str + '<td align="right" style="width: 150px;font-size: 13px; padding: 0px 8px 0px 0px; vertical-align: middle">Receipt No.: <span style=" padding: 0px;" id="receiptNo"></span>'+obj.students['invoice_ID']+' </td>';
				str = str + '</tr>';
				...
				str = str + '<td width="160px"><label class="receipt_label">: Rs.</label><input type="hidden" id="due_amnt_input" name="due_amnt_input" value="'+due_Amount+'" style="width: 100px; padding: 0px; border:#f0f0f0 solid 1px">'+due_Amount+'/-</td>';
				str = str + '</td>';
				str = str + '</tr>';
