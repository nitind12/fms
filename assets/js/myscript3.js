	...
	$(function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				for(i=0; i<obj.flex.length; i++){
					str = str + "<tr>";
					str = str + '<td><input type="radio"  value="'obj.flex[i]['flexible_head_ID']'"  class="flexi" name"flex_head" id='"+obj.flex[i]['flexible_head_ID']+"'></td>';
					str = str + "<td>" + obj.flex[i]['fee_Head'] + "</td>";
					str = str + "</tr>";
				}
		...
		$.ajax({
			...
			success: function(data){
				...
				for(i=0; i<obj.clssTotal.length; i++){
					str = str + "<tr>";
					str = str + '<td><input type="radio"  value="'obj.clssTotal[i]['class_ID']'" name="clss" id="'+obj.clssTotal[i]['class_ID']+'" value="id1" class="stdi"></td>';
		...
		$.ajax({
			...
			success:function(data){
				...
				for(i=0;i<obj.stud.length;i++){
					str = str + '<tr>';
					str = str + '<td><input type="checkbox" value="'obj.stud[i]['student_ID']'" id="'+obj.stud[i]['student_ID']+'"></td>';
