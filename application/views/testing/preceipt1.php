<div class="row">
	...
	<tr>
					<td>
						<table table  align ="center" style="width: 800px; font-size: 13px; font-family: verdana; border:#808080 solid 1px; background: #ffffff" class="table print_me ">
							<tbody><tr class="feeHeader" align="center" style="width: 500px;padding: 0px 0px 0px 8px; vertical-align: middle">
								<td width="">
								<td height="">
								<td align="left" style="width: px;font-size: 13px; padding: 0px 8px 0px 0px 0px 0px 0px; vertical-align: left">
					...
					<td>
							...
							<tr class="myfont">
								...
								<td colspan="2" width="50%" valign="top">
									<table border="0" class="myfont" cellpadding="5">
																				<tbody><tr valign="top">
											<td class="label_" width="20">Submission Date:<?php echo
											date('d-m-Y');?></td>
											<td class="content"></td>
										</tr>
																				<tr valign="top">
