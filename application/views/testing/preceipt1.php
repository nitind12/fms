								...
								<td colspan="2" width="50%" valign="top" >
									<table border="0" class="myfont" cellpadding="5">
										<tbody><tr>
											...
											Reg. No.:<?php	echo $receipt->student_ID;
											?>
											</td>
											<td class="content"></td>
										...
										<tr>
											<td class="label_">Name:&nbsp<?php	echo $receipt->first_Name . ' '. $receipt->last_Name;?></td>
											<td class="content"></td>
										</tr>
										<tr>
											<td class="label_">Father:&nbsp<?php	echo $receipt->fathers_Name;?></td>
											<td class="content"></td>
										</tr>
										<tr>
											<td class="label_">Class:&nbsp<?php echo $receipt->course .' '. $receipt->sem_ID . ' ' . $receipt->section;?></td>
											<td class="content"></td>
										</tr>
										<tr>
											<td class="label_">Invoice No.:&nbsp<?php	echo $receipt->invoice_ID;?></td>
											<td class="content"></td>
										</tr>
																			</tbody></table>
								</td>
