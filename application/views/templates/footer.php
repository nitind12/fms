...
<script type="text/javascript" src="<?php echo base_url('assets/js/myscript3.js');?>?version=4.5"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/student.js');?>?version=2.2"></script>
