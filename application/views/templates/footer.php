...
<script type="text/javascript" src="<?php echo base_url('assets/js/statichead.js');?>?version=1.4"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/class_sesswise.js');?>?version=1.0"></script>
