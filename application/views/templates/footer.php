...
<script type="text/javascript" src="<?php echo base_url('assets/js/class_in_session.js');?>?version=4.8"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/receiptdisplay.js');?>?version=2.2"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/displaydue.js');?>?version=1.5"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/class_sesswise.js');?>?version=1.3"></script>
