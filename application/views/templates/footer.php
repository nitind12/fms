...
<script type="text/javascript" src="<?php echo base_url('assets/js/invoice.js');?>?version=8.1"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/invoiceprint.js');?>?version=1.5"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/receipt.js');?>?version=1.8"></script>
