...
<script type="text/javascript" src="<?php echo base_url('assets/js/class_in_session.js');?>?version=3.8"></script>

<script type="text/javascript" src="<?php echo base_url('assets/js/class.js');?>?version=5.6"></script>
