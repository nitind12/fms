...
<script type="text/javascript" src="<?php echo base_url('assets/js/invoice.js');?>?version=8.8"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/myscript2.js');?>?version=1.1"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/myscript3.js');?>?version=2.5"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/receipt.js');?>?version=3.1"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/invoiceprint.js');?>?version=2.4"></script>
