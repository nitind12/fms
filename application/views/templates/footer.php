...
<script type="text/javascript" src="<?php echo base_url('assets/js/invoice.js');?>?version=21.7"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/class_in_session.js');?>?version=3.7"></script>

<script type="text/javascript" src="<?php echo base_url('assets/js/class.js');?>?version=4.9"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/statichead.js');?>?version=1.2"></script>
