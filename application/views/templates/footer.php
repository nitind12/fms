...
<script type="text/javascript" src="<?php echo base_url('assets/js/invoice.js');?>?version=6.4"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/receipt.js');?>?version=1.5"></script>
