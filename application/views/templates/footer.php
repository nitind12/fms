...
<script type="text/javascript" src="<?php echo base_url('assets/js/invoice.js');?>?version=12.9"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/invoice.js');?>?version=12.3"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/receipt.js');?>?version=6.2"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/receipt.js');?>?version=4.5"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/student.js');?>?version=1.4"></script>
