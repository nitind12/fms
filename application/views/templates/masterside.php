<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="parent active"><a data-toggle="collapse" href="#sub-item-2"><em class="fa fa-user-circle-o">&nbsp;</em>
			...
			<ul class="children collapse" id="receipt">
				<li><a class="" href="ireceipt"><span class="fa fa-arrow-right">&nbsp;</span>Invoice/Receipt</a></li>
			</ul>
			</li>
